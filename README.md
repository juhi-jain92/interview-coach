...
1. **Grill**: a design-tree interrogation command adapted from https://www.aihero.dev/use-the-grill-me-skill-k029d. Maps one story as a tree of decisions and walks the
   ...
   interviews.
3. **Self-updating limitations loop**: `interview-limitations.md` tracks
...
4. **Two-lens scoring**: every answer is scored on two independent axes,
...
5. **Seven-check tactical layer**: under the delivery dimensions sits a
